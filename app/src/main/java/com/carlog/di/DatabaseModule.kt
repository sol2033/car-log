...
import com.carlog.data.local.MIGRATION_11_12
import com.carlog.data.local.MIGRATION_12_13
import com.carlog.data.local.MIGRATION_13_14
import com.carlog.data.local.MIGRATION_14_15
import com.carlog.data.local.MIGRATION_15_16
import com.carlog.data.local.MIGRATION_16_17
import com.carlog.data.local.MIGRATION_17_18
import com.carlog.data.local.MIGRATION_18_19
import com.carlog.data.local.MIGRATION_19_20
import com.carlog.data.local.MIGRATION_20_21
import com.carlog.data.local.MIGRATION_21_22
...
object DatabaseModule {
    ...
    @Provides
    @Singleton
    fun provideCarDocumentDao(database: CarLogDatabase): CarDocumentDao {
        return database.carDocumentDao()
    }
}
